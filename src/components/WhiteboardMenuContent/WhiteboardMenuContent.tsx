...
import { WhiteboardActiveMenu } from '../../slices/whiteboardSlice';
...
export default class WhiteboardMenuContent extends Component<WhiteboardMenuContentProps> {
  ...
  get whiteboardBrushColor() {
    return this.isActive('color') && <WhiteboardBrushColor color={this.props.brushColor} handleChange={this.props.handleBrushColorChange} />;
  }

  get whiteboardBrushSize() {
    return this.isActive('size') && <WhiteboardBrushSize size={this.props.brushSize} handleChange={this.props.handleBrushSizeChange} />;
  }
