...
import WhiteboardCanvasService, { WhiteboardCanvasZoom } from '../../hooks/Whiteboard/WhiteboardCanvasService';
...
export default class WhiteboardMenu extends Component<WhiteboardMenuProps> {
  ...
  get menuItems() {
    return WhiteboardMenu.items.map((item) => <WhiteboardMenuItem name={item} handleClick={this.handleItemClick} key={item} />);
  }
